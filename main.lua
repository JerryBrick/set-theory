...
print("\n  P(B): " .. fns.stringifySet(powerSetB))
print()
...
print("\n  #(P(A) / P(B)): " .. fns.calculatecardinality(powerSetsDifference))
print("\n  (AnB)x(AuB): " .. fns.stringifySet(fns.calculateCartesianProduct(intersection, union)))
print()
